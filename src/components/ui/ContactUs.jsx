  ...
  return (
    ...
    >
      ...
      <motion.form
        ...
        className="bg-white shadow-lg border border-gray-200 rounded-xl p-10 space-y-6"
        variants={childVariants}
      >
        {/* Name Field */}
        <div className="relative">
          <motion.label
            animate={{
              ...
              color: floatingStyle("name") ? "#ec4899" : "#6b7280",
        ...
        <div className="relative">
          <motion.label
            animate={{
              ...
              color: floatingStyle("email") ? "#ec4899" : "#6b7280",
        ...
        <div className="relative">
          <motion.label
            animate={{
              ...
              color: floatingStyle("message") ? "#ec4899" : "#6b7280",
